...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "dashboard.DashboardData": {
            ...
            "properties": {
                "activeCreators": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.CreatorInfo"
                    }
                },
                "activeReceivers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.ReceiverInfo"
                    }
                },
                "activityData": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.DateValue"
                    }
                },
                "applyStatus": {
                    "$ref": "#/definitions/dashboard.ApplyStatus"
                },
                "distributeModes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.NameValue"
                    }
                },
                "hotProjects": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.ProjectInfo"
                    }
                },
                "projectTags": {
                    "type": "array",
        ...
        "dashboard.DashboardDataResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/dashboard.DashboardData"
                },
                "error_msg": {
                    "type": "string"
                }
